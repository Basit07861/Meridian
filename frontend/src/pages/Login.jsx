...
export default function Login() {
  ...
  const S = {
    ...
    labelRow: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, marginBottom: 7 },
    label: {
      display: 'block',
      fontSize: 11,
      fontWeight: 600,
            ...
            <>
              <form onSubmit={handleSubmit} noValidate>
                <div style={S.fieldWrap}>
                  <label style={S.label} htmlFor="identifier-input">Email or Username</label>
                  <input
                    id="identifier-input"
                    type="text"
                ...
                <div style={S.fieldWrap}>
                  <div style={S.labelRow}>
                    ...
                    <Link to="/forgot-password" style={S.miniLink}>Forgot password?</Link>
                  </div>
              ...
              <button
                ...
                onMouseEnter={(e) => { e.currentTarget.style.background = 'var(--border)'; e.currentTarget.style.borderColor = 'var(--surface-15)'; }}
                onMouseLeave={(e) => { e.currentTarget.style.background = 'var(--surface-04)'; e.currentTarget.style.borderColor = 'var(--surface-10)'; }}
